  ...
  render() {
    return (
      ...
      <form className='Transfer' onSubmit={this.props.onhandleTransfer} style={{width: "100%", display: "inline-block"}}>
        <h3 style={{fontFamily: "Open Sans", marginTop: "0", margin: "0 auto", marginBottom: "15px", textAlign: "center"}}> Transfer Ownership of Bounty</h3>
        ...
        <button type='submit' className='AddBtn' style={{width: "100%", backgroundColor: "#65C5AA", border:"0px"}}>Transfer</button>
