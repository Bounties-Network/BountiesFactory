        ...
        <div id={"colourBodyLight"} style={{minHeight: "100vh", position: "relative", overflow: "hidden"}}>
          <Navigation userAddress={""}/>
            <div style={{display: "block", overflow: "hidden", width: "1050px", padding: "15px", margin: "0 auto", marginBottom: "75px", marginTop: "15px", backgroundColor: "rgb(249,249,249)", border: "0px", borderBottom: "0px solid #4a79fa", color:"rgb(25, 55, 83)"}} className="ContractCard">
              ...
              <p>
                This privacy policy (“<b>Policy</b>”) describes how ConsenSys AG’s Bounties (“<b>Bounties</b>” “<b>Company</b>”, “<b>we</b>”, “<b>our</b>”, or “<b>us</b>”) collects, uses, shares, and stores personal information of users of this website, <a href="https://bounties.network/">https://bounties.network/</a> (the “<b>Site</b>”). This Policy applies to the Site, applications, products and services (collectively, “<b>Services</b>”) on or in which it is posted, linked, or referenced.
              </p>
              <p>
              ...
              <p>
              <b>Information You Give Us.</b> Information we collect from you may include:
              <ul>
                <li style={{listStyleType:"disc"}}>Optional Contact information, such as your email address;</li>
                <li style={{listStyleType:"disc"}}>Optional Profile information, such as your username, photograph, Github profile link, social media profile links, description of skills, and past experiences;</li>
                <li style={{listStyleType:"disc"}}>Feedback and correspondence, such as information you provide in your responses to surveys, when you participate in market research activities, report a problem with Service, receive customer support or otherwise correspond with us;</li>
                <li style={{listStyleType:"disc"}}>Your blockchain public key;</li>
                <li style={{listStyleType:"disc"}}>Usage information, such as information about how you use the Service and interact with us; and</li>
                <li style={{listStyleType:"disc"}}>Marketing information, such as your preferences for receiving marketing communications and details about how you engage with them.</li>
              </ul>
              </p>
              <p>
              If you are visiting this site from the European Union (EU), see our Notice to EU Data Subjects below for our legal bases for processing and transfer of your data.
              ...
              <p>
              We also use Google Analytics to help us offer you an optimized user experience.  You can find more information about Google Analytics’ use of your personal data here:
              <a href="https://www.google.com/analytics/terms/us.html">https://www.google.com/analytics/terms/us.html</a>
              </p>
              <p>
              <b>Information we will never collect.</b> We will never ask you to share your private keys or wallet seed. Never trust anyone or any site that asks you to enter your private keys or wallet seed.
              </p>
              <h4>USE OF PERSONAL INFORMATION</h4>
              <p>
              <b><i>To provide our service</i></b><br/>
              We will use your personal information in the following ways:
              <ul>
                <li style={{listStyleType:"disc"}}>To enable you to access and use the Services</li>
                <li style={{listStyleType:"disc"}}>To provide and deliver products and services that you may request.</li>
                <li style={{listStyleType:"disc"}}>To send information, including confirmations, technical notices, updates, security alerts, and support and administrative messages.</li>

              </ul>
              </p>
              <p>
              <b><i>To comply with law</i></b><br/>
              We use your personal information as we believe necessary or appropriate to comply with applicable laws , lawful requests and legal process, such as to respond to subpoenas or requests from government authorities.
              </p>
              <p>
              <b><i>To communicate with you</i></b><br/>
              We use your personal information to communicate about promotions, upcoming events, and other news about products and services offered by us and our selected partners.
              </p>
              <p>
              <b><i>To optimize our platform</i></b><br/>
              ...
              <p>
              <b><i>For compliance, fraud prevention, and safety</i></b><br/>
              ...
              <ul>
                <li style={{listStyleType:"disc"}}><b>Affiliates.</b> We may disclose your personal information to our subsidiaries and corporate affiliates for purposes consistent with this Privacy Policy.</li>
                <li style={{listStyleType:"disc"}}><b>Business Transfers.</b> We may share personal information when we do a business deal, or negotiate a business deal, involving the sale or transfer of all or a part of our business or assets. These deals can include any merger, financing, acquisition, or bankruptcy transaction or proceeding.</li>
                <li style={{listStyleType:"disc"}}><b>Compliance with Laws and Law Enforcement; Protection and Safety.</b> We may share personal information for legal, protection, and safety purposes.
                <ul>
                  <li style={{listStyleType:"disc"}}>We may share information to comply with laws.</li>
                  <li style={{listStyleType:"disc"}}>We may share information to respond to lawful requests and legal processes.</li>
                  <li style={{listStyleType:"disc"}}>We may share information to protect the rights and property of the Company, our agents, customers, and others. This includes enforcing our agreements, policies, and terms of use.</li>
                  <li style={{listStyleType:"disc"}}>We may share information in an emergency. This includes protecting the safety of our employees and agents, our customers, or any person.</li>
                </ul>

                </li>
                <li style={{listStyleType:"disc"}}><b>Professional Advisors and Service Providers.</b> We may share information with those who need it to do work for us. These recipients may include third party companies and individuals to administer and provide the Service on our behalf (such as customer support, hosting, email delivery and database management services), as well as lawyers, bankers, auditors, and insurers.</li>
                <li style={{listStyleType:"disc"}}><b>Other. </b> You may permit us to share your personal information with other companies or entities of your choosing. Those uses will be subject to the privacy policies of the recipient entity or entities. </li>
              ...
              <p>
              <b><i>Accessing, Updating, Correcting, and Deleting your Information</i></b><br/>
              You may access information that you have voluntarily provided through your account on the Services, and to review, correct, or delete it by sending a request to contact@bounties.network. You can request to change contact choices, opt-out of our sharing with others, and update your personal information and preferences.
              </p>
              <p>
              <b><i>Tracking Technologies Generally</i></b><br/>
              ...
              <p><b>CONTACT INFORMATION.</b> We welcome your comments or questions about this Policy, and you may contact us at: contact@bounties.network.</p>
              <p><b>CHANGES TO THIS PRIVACY POLICY.</b> We may change this privacy policy at any time. We encourage you to periodically review this page for the latest information on our privacy practices. If we make any changes, we will change the Last Updated date above.<br/>
              ...
              With respect to EU data subjects, “personal information,” as used in this Privacy Policy, is equivalent to “personal data” as defined in the <a href="https://gdpr-info.eu/art-4-gdpr/">European Union General Data Protection Regulation (GDPR)</a>.
              </p>
              <p><b><i>Sensitive Data</i></b><br/>
              ...
              <p><b><i>Legal Bases for Processing</i></b><br/>
              We only use your personal information as permitted by law. We are required to inform you of the legal bases of our processing of your personal information, which are described in the table below. If you have questions about the legal bases under which we process your personal information, contact us at contact@bounties.network.
              </p>
              <table style={{width: "100%", border: "1px solid #1a3853"}} border="1">
                <tr>
                <th style={{padding: "15px", width: "30%", borderRight: "1px solid #1a3853", borderBottom: "1px solid #1a3853"}}>
                <b><i>Processing Purpose</i></b>
                </th>
                <th style={{padding: "15px", borderBottom: "1px solid #1a3853"}}><b><i>Legal Basis</i></b></th>
                </tr>
                <tr>
                <td style={{padding: "15px", width: "30%", borderRight: "1px solid #1a3853", borderBottom: "1px solid #1a3853"}}><u>To communicate with you<br/><br/>

              To optimize our platform<br/><br/>

              For compliance, fraud prevention, and safety<br/><br/>

              To provide our service</u>
              </td>
              ...
              These processing activities constitute our legitimate interests. We make sure we consider and balance any potential impacts on you (both positive and negative) and your rights before we process your personal information for our legitimate interests. We do not use your personal information for activities where our interests are overridden by any adverse impact on you (unless we have your consent or are otherwise required or permitted to by law).
                ...
                <tr>
                <td style={{padding: "15px", width: "30%", borderRight: "1px solid #1a3853", borderBottom: "1px solid #1a3853"}}><u>To comply with law</u></td>
                <td style={{padding: "15px", borderBottom: "1px solid #1a3853"}}>We use your personal information to comply with applicable laws and our legal obligations.</td>
                </tr>
                <tr>
                <td style={{padding: "15px", width: "30%", borderRight: "1px solid #1a3853"}}><u>With your consent</u></td>
                <td style={{padding: "15px"}}>
              Where our use of your personal information is based upon your consent, you have the right to withdraw it anytime in the manner indicated in the Service or by contacting us at contact@bounties.network
              </td>
                </tr>
              </table>
              <p><b><i>Use for New Purposes</i></b><br/>
              ...
              <ul>
                <li style={{listStyleType:"disc"}}><b>Opt-out.</b> Stop sending you direct marketing communications which you have previously consented to receive. We may continue to send you Service-related and other non-marketing communications.</li>
                <li style={{listStyleType:"disc"}}><b>Access.</b> Provide you with information about our processing of your personal information and give you access to your personal information.</li>
                <li style={{listStyleType:"disc"}}><b>Correct.</b> Update or correct inaccuracies in your personal information.</li>
                <li style={{listStyleType:"disc"}}><b>Delete.</b> Delete your personal information.</li>
                <li style={{listStyleType:"disc"}}><b>Transfer.</b> Transfer a machine-readable copy of your personal information to you or a third party of your choice.</li>
                <li style={{listStyleType:"disc"}}><b>Restrict.</b> Restrict the processing of your personal information.</li>
                <li style={{listStyleType:"disc"}}><b>Object.</b> Object to our reliance on our legitimate interests as the basis of our processing of your personal information that impacts your rights.</li>
              </ul>
              <p>You can submit these requests by email to contact@bounties.network. We may request specific information from you to help us confirm your identity and process your request. Applicable law may require or permit us to decline your request. If we decline your request, we will tell you why, subject to legal restrictions. If you would like to submit a complaint about our use of your personal information or response to your requests regarding your personal information, you may contact us at contact@bounties.network or submit a complaint to the data protection regulator in your jurisdiction. You can find your data protection regulator <a href="http://ec.europa.eu/justice/article-29/structure/data-protection-authorities/index_en.htm">here</a>.
              </p>
              <p>
              <b><i>Cross-Border Data Transfer</i></b>
              Please be aware that your personal data will be transferred to, processed, and stored in the United States. Data protection laws in the U.S. may be different from those in your country of residence. You consent to the transfer of your information, including personal information, to the U.S. as set forth in this Privacy Policy by visiting our site or using our service.<br/>
              Whenever we transfer your personal information out of the EEA to the U.S. or countries not deemed by the European Commission to provide an adequate level of personal information protection, the transfer will be based on a data transfer mechanism recognized by the European Commission as providing adequate protection for personal information.<br/>
              ...
              <p>
              <b><i>Why do we use Cookies?</i></b>
              We generally use Cookies for the following purposes:
              <ul>
                <li style={{listStyleType:"disc"}}>To recognize new or past customers.</li>
                <li style={{listStyleType:"disc"}}>To store your password if you are registered on our Site.</li>
                <li style={{listStyleType:"disc"}}>To improve our Site and to better understand your visits on our platforms and Site.</li>
                <li style={{listStyleType:"disc"}}>To serve you with interest-based or targeted advertising.</li>
                <li style={{listStyleType:"disc"}}>To observe your behaviors and browsing activities over time across multiple websites or other platforms.</li>
                <li style={{listStyleType:"disc"}}>To better understand the interests of our customers and our website visitors.</li>
              </ul>
              </p>
              <p>
              ...
              <p>
              <b><i>How to disable Cookies. </i></b>
              You can generally activate or later deactivate the use of cookies through a functionality built into your web browser. To learn more about how to control cookie settings through your browser:<br/><br/>

              Click <a href="https://support.mozilla.org/en-US/kb/enable-and-disable-cookies-website-preferences">here</a> to learn more about the “Private Browsing” setting and managing cookie settings in Firefox;<br/><br/>

              Click <a href="https://support.google.com/chrome/answer/95647?hl=en">here</a> to learn more about “Incognito” and managing cookie settings in Chrome;<br/><br/>

              Click <a href="https://support.microsoft.com/en-us/help/17442/windows-internet-explorer-delete-manage-cookies">here</a> to learn more about “InPrivate” and managing cookie settings in Internet Explorer; or<br/><br/>

              Click <a href="https://support.apple.com/kb/ph21411?locale=en_US">here</a> to learn more about “Private Browsing” and managing cookie settings in Safari.<br/><br/>

              If you want to learn more about cookies, or how to control, disable or delete them, please visit <a href="http://www.aboutcookies.org">http://www.aboutcookies.org</a> for detailed guidance. In addition, certain third party advertising networks, including Google, permit users to opt out of or customize preferences associated with your internet browsing. To learn more about this feature from Google, click <a href="https://adssettings.google.com/u/0/authenticated?hl=en">here</a>.<br/><br/>
              </p>
              <p>
              ...
              <table style={{width: "100%", border: "1px solid #1a3853"}} border="1">
                <tr>
                <th style={{padding: "15px", width: "20%", borderRight: "1px solid #1a3853", borderBottom: "1px solid #1a3853"}}>
                <b><i>Name of Cookie/Identifier</i></b>
                </th>
                <th style={{padding: "15px", width: "20%", borderRight: "1px solid #1a3853", borderBottom: "1px solid #1a3853"}}>
                <b><i>What does the cookie generally do (e.g., website function and administration, analytics, marketing)?</i></b>
                </th>
                <th style={{padding: "15px", width: "20%", borderRight: "1px solid #1a3853", borderBottom: "1px solid #1a3853"}}>
                <b><i>Is it a 1st or 3rd party cookie and what is the name of the party providing it?</i></b>
                </th>
                <th style={{padding: "15px", width: "20%", borderRight: "1px solid #1a3853", borderBottom: "1px solid #1a3853"}}>
                <b><i>What type of cookie is it (persistent or session)?</i></b>
                </th>
                <th style={{padding: "15px", width: "20%",borderBottom: "1px solid #1a3853"}}>
                <b><i>What is the duration of the cookie on the website (if not cleared by the user)?</i></b>
                </th>
                </tr>
                <tr>
