    ...
    return (
      ...
      <div style={{width: "215px", marginBottom: "0px", boxShadow: "none", borderRadius: "0", padding: "15px", color: "white", border: "0", borderBottom: "1px solid rgba(101, 197, 170, 0.5)"}} className="ContractCard">
        <div style={{float: "left", display: "inline-block", width: "190px"}}>
          ...
          <p style={{ fontSize: "12px", width: "100%", margin: "2.5px 0px"}}><b style={{color: "#FFDE46", fontWeight: "200"}}>Balance:</b> {this.props.balance + " "+this.props.symbol} | <b style={{color: "#FFDE46", fontWeight: "200"}}>Stage: </b>{this.props.stage}</p>
        </div>
        <a style={{marginTop: "11px", color: "#65C5AA", textAlign: "right"}}> <SvgArrow style={{color: "#65C5AA", fontSize: "44px"}}/></a>
