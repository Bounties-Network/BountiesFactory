    ...
    return (
      ...
      <Dialog
       ...
       <Dialog
        ...
        <p style={{textAlign: "center", fontSize: "10px", padding: "15px", color: this.state.lightMode? "rgb(25, 55, 83)":"rgba(256,256,256,0.75)"}}>&copy; Bounties Network, a <a href="https://ConsenSys.net" target="_blank" style={{textDecoration: "none", color: this.state.lightMode? "rgb(25, 55, 83,0.75)": "#16e5cd"}}>ConsenSys</a> Formation <br/>
